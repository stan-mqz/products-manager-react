      ...
      <tr className="border-b border-gray-400 ">
        ...
        <td className="p-3 text-lg text-gray-800">
          ...
          <fetcher.Form method="POST">
            ...
            name="id"
            value={product.id}
            className={`${isAvailable ? 'text-black': 'text-red-600'} rounded-lg p-2 text-xs uppercase font-bold w-full border border-gray-400 hover:cursor-pointer`}
        ...
        <td className="p-3 text-lg text-gray-800 ">
          <div className="flex gap-2 items-center">
            ...
            <Form
              ...
              onSubmit={(e) => {
                //Esto se ejecuta antes que el action
                if (!confirm("¿Eliminar?")) {
                  e.preventDefault();
                }
              }}
